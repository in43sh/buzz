  ...
  return (
    <div className="policy-container">
      ...
      <p className="text pb-10">
        [Business Entity Name] (“we” or “us” or “our”) may use cookies, web beacons, tracking
        pixels, and other tracking technologies when you visit our website [Name of Website.com],
        including any other media form, media channel, mobile website, or mobile application related
        or connected thereto (collectively, the “Site”) to help customize the Site and improve your
        experience.{' '}
      </p>
      <p className="text pb-10">
      ...
      <p className="text pb-10">
        This{' '}
        <a href="https://termly.io/resources/templates/cookie-policy-template/">cookie policy</a>{' '}
      ...
      <p className="text pb-10">
        Advertising cookies are placed on your computer by advertisers and ad servers in order to
        display advertisements that are most likely to be of interest to you. These cookies allow
        advertisers and ad servers to gather information about your visits to the Site and other
      ...
      <p className="text pb-10">
        ...
        features and functionalities. Some of these may be manually disabled in your browser, but
